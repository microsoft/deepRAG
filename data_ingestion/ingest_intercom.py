...
async def ingest_intercom(product, root_collection_ids: List[str], source='intercom', concurrent_tasks=60,
                          output_file='processed_data/intercom_pages.jsonl', secret_key="INTERCOM_TOKEN") -> None:

    logger.info(f"Fetching Intercom pages for {product}...")
