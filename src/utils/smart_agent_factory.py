...
from models import AgentConfiguration, agent_configuration_from_dict, Settings
from services import History
from agents import Smart_Agent
from redis.typing import KeyT, ResponseT, AbsExpiryT, ExpiryT, EncodableT
from io_wrapper import read_file
...
class SmartAgentFactory:
    ...
    def create_smart_agent(settings: Settings, session_id: str) -> Smart_Agent:
        ...
        with read_file(file_path=settings.smart_agent_prompt_location) as file:
